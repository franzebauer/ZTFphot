...
def calib_catalog(ref_catalog, input_catalog, output_catalog, img_kind, vet_catalog=None,
    ...
    cols = [
        ...
        pf.Column(name='MAG_3_TOT_AB_org',  format='D', array=magQi[0]),
        pf.Column(name='MERR_3_TOT_AB_org', format='D', array=errmagQi[0]),
        pf.Column(name='MAG_4_TOT_AB_org',  format='D', array=magQi[1]),
        pf.Column(name='MERR_4_TOT_AB_org', format='D', array=errmagQi[1]),
        pf.Column(name='MAG_6_TOT_AB_org',  format='D', array=magQi[2]),
        pf.Column(name='MERR_6_TOT_AB_org', format='D', array=errmagQi[2]),
        pf.Column(name='MAG_10_TOT_AB_org', format='D', array=magQi[3]),
        pf.Column(name='MERR_10_TOT_AB_org',format='D', array=errmagQi[3]),
